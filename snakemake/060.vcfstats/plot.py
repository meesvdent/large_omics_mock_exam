...
#   plot-vcfstats -p 060.vcfstats/ 060.vcfstats/stats.vcfk
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. snps. .. 050.snpeff/snps.annotated.vcf
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='snps.')
    has_data = 1
